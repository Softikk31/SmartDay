...
import com.example.smartday.data.sources.local.converters.task.ConvertersRepetition
import com.example.smartday.data.sources.local.converters.task.ConvertersSubtask
...
@Database(
    entities = [TaskEntity::class, ThemeEntity::class],
    version = 3
)
@TypeConverters(
    ConvertersDateTime::class,
    ConvertersPriority::class,
    ConvertersRepetition::class,
    ConvertersPrimaryColor::class,
    ConvertersSubtask::class
)
